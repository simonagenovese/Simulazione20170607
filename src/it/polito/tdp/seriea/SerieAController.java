...
public class SerieAController {
    ...
    void handleCarica(ActionEvent event) {
    	...
    	if(season == null) {
    		txtResult.setText("Errore nella scelta della stagione.\n");
    		return;
    	}
    	model.createGraph(season);
    	
    	List<Team> list = model.getClassifica();
    	String result = "";
    	for(Team t : list) {
    		result += t.getTeam()+" "+t.getPunteggio()+"\n";
    	}
	...
	public void setModel(Model model) {
		this.model=model;
        boxSeason.getItems().addAll(model.getListaStagioni());
        boxTeam.getItems().addAll(model.getListaSquadre());
	}
}
